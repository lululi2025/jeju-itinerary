...
/* ─────────────────────────────────────────────────────────────
   🏔️  MUST-VISIT  — 12 attractions
   All URLs re-verified 2026-05-27 (HTTP 200 + 對應內容存在)
   ───────────────────────────────────────────────────────────── */
const MUST_VISITS = [
  {
    id: 'ilchulbong',
    ...
    tag: '世界遺產 🌋',
    emoji: '🌋',
    url: 'https://www.kkday.com/zh-tw/blog/3367/asia-korea-jeju-island-must-visit',
    source: 'KKday Blog ‧ 必去 Top30',
    duration: '1.5 - 2 小時',
  ...
  },
  {
    ...
    tag: '海景夕陽 ☕️',
    emoji: '☕️',
    url: 'https://mimigo.tw/jeju-travel/',
    source: 'Mimi韓の旅遊指南',
    duration: '2 - 3 小時',
